...
var emptyCmd = &cobra.Command{
	...
	Long:  "Generates an empty TOML file in the templates directory. This is a template to scaffold D&D characters with.",
	RunE: func(cmd *cobra.Command, args []string) error {
		// Generate empty TOML if needed
		if err := templates.GenerateEmptyTOML(); err != nil {
